...
3. **OPTIMIZE** — Walk the ADR section-by-section with the user. For every Open Question, replace `Default:` with `Decision:` based on user input. Don't skip the surface-parity matrix.
